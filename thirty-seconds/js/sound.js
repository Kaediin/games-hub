...
const PRESETS = {
  ...
  unmark() {
    tone({ freq: 360, sweepTo: 240, dur: 0.1, type: "sine", gain: 0.12 });
  },
  go() {
    tone({ freq: 392, dur: 0.1, type: "triangle", gain: 0.16 });
    tone({ freq: 523, dur: 0.16, type: "triangle", gain: 0.16, when: 0.1 });
  },
  countdown() {
    tone({ freq: 660, dur: 0.08, type: "square", gain: 0.1 });
  },
  tick() {
  ...
  timeUp() {
    ...
    noise({ dur: 0.25, gain: 0.08, filter: 500 });
  },
  move() {
    tone({ freq: 440, sweepTo: 660, dur: 0.12, type: "triangle", gain: 0.14 });
  },
  win() {
